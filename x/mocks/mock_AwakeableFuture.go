...
func (_m *MockAwakeableFuture) Result(output any) errors.TerminalError {
...
func (_c *MockAwakeableFuture_Result_Call) Return(_a0 errors.TerminalError) *MockAwakeableFuture_Result_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MockAwakeableFuture_Result_Call) RunAndReturn(run func(any) errors.TerminalError) *MockAwakeableFuture_Result_Call {
	_c.Call.Return(run)
	return _c
}

// handle provides a mock function with no fields
func (_m *MockAwakeableFuture) handle() uint32 {
	ret := _m.Called()
...
func (_e *MockAwakeableFuture_Expecter) handle() *MockAwakeableFuture_handle_Call {
	return &MockAwakeableFuture_handle_Call{Call: _e.mock.On("handle")}
}

func (_c *MockAwakeableFuture_handle_Call) Run(run func()) *MockAwakeableFuture_handle_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run()
	})
	return _c
...
func (_c *MockAwakeableFuture_handle_Call) Return(_a0 uint32) *MockAwakeableFuture_handle_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MockAwakeableFuture_handle_Call) RunAndReturn(run func() uint32) *MockAwakeableFuture_handle_Call {
	_c.Call.Return(run)
	return _c
}
