...
func (_m *MockResponseFuture) Response(output any) errors.TerminalError {
...
func (_c *MockResponseFuture_Response_Call) Return(_a0 errors.TerminalError) *MockResponseFuture_Response_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MockResponseFuture_Response_Call) RunAndReturn(run func(any) errors.TerminalError) *MockResponseFuture_Response_Call {
	_c.Call.Return(run)
	return _c
}
