...
func (_m *MockClient) Request(input any, output any, opts ...options.RequestOption) errors.TerminalError {
	...
	if rf, ok := ret.Get(0).(func(any, any, ...options.RequestOption) errors.TerminalError); ok {
...
func (_c *MockClient_Request_Call) Return(_a0 errors.TerminalError) *MockClient_Request_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MockClient_Request_Call) RunAndReturn(run func(any, any, ...options.RequestOption) errors.TerminalError) *MockClient_Request_Call {
	_c.Call.Return(run)
	return _c
}
