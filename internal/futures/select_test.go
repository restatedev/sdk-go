...
func (f *fakeContext) Awakeable() (restate.Awakeable[[]byte], error) {
	return futures.NewAwakeable(context.TODO(), nil, 0, nil), nil
}
...
func TestSelect(t *testing.T) {
	...
	awakeableTwo, err := restate.AwakeableAs[string](&fakeContext{})
	if err != nil {
		t.Fatal(err)
	}
